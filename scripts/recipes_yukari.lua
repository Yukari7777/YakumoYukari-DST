...
AddRecipe("spellcard_mesh", {Ingredient("nightmarefuel", 2), Ingredient("nitre", 2)}, TOUHOU, TECH.MAGIC_TWO, nil, nil, nil, nil, nil, "images/inventoryimages/spellcard_mesh.xml", "spellcard_mesh.tex")
...
AddRecipe("powerultsw", {Ingredient("townportaltalisman", 20), Ingredient("sleepbomb", 20), SchemetoolIngredient }, TOUHOU, TECH.ANCIENT_FOUR, nil, nil, true, nil, nil, "images/inventoryimages/powerultsw.xml", "powerultsw.tex")