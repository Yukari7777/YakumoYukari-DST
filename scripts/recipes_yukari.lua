...
AddRecipe("spellcard_balance", { Ingredient("ice", 30), Ingredient("nitre", 5), Ingredient("poop", 5)}, TOUHOU, TECH.MAGIC_TWO, nil, nil, nil, nil, nil, "images/inventoryimages/spellcard_balance.xml", "spellcard_balance.tex")
