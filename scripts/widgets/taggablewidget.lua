...
function TaggableWidget:OnBecomeActive()
...
function TaggableWidget:OverrideText(text)
    self.edit_text:SetString(text)
    self.edit_text:SetFocus()
end

function TaggableWidget:GetText()
    return self.edit_text:GetString()
end

function TaggableWidget:SetValidChars(chars)
    self.edit_text:SetCharacterFilter(chars)
end

function TaggableWidget:OnControl(control, down)
    if TaggableWidget._base.OnControl(self,control, down) then return true end
